...
const Footer = () => {
    return (
        <div className='h-52 bg-orange-200'>
          <div className='grid lg:grid-cols-3'>
            <div className='ms-5'>
               <div className='flex bg-red-600 w-52 rounded-lg mt-10 '> <p className='text-black rounded-md'>find us on twitter</p> <p><AiFillTwitterCircle/></p></div>
               <div className='flex bg-red-600 w-52 rounded-lg mt-3'> <p  className='text-black rounded-md'> find us on facebook  </p><p><AiFillFacebook/></p></div>
                <p>find us on </p>
            </div>
            <div>
                <p className='text-center text-black text-2xl'>Terms and conditions</p>
